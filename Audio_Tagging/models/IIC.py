...
def semi_supervised_IIC(input_shape, num_classes, final_act):
    ...
    cluster_output1 = Activation(activation=final_act)
    ...
    output_clf = Activation(activation=final_act)
    ...
    output1 = cluster_output1(model, name='cluster_output')
    ...
    output2 = cluster_output2(augmented_model, name='cluster_augmentation_output')

    # classification block
    clf_model = conv7_clf(clf_fork)
    clf_model = lambda_7_1_clf(clf_model)
    clf_model = lambda_7_2_clf(clf_model)
    clf_output = output_clf(clf_model, name='clf_output')
